...
3. The RAG pipeline expects posts to be stored in a database — this project uses a local MongoDB instance, but you can swap in any database that fits your setup.
...
| **Research** | Wraps the RAG retrieval pipeline to pull relevant reference material. |
| **Copywriter** | Writes the draft using style constraints and retrieved context. |
